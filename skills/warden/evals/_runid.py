# Copied from skills/temper/evals/_runid.py (#424). Mirrors temper's helper; kept AST-identical by scripts/check_warden_helper_drift.py.
"""Run-id validation utility for the warden eval harness (#464). I-9 enforcement;
